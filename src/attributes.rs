...
impl PathAttribute {
    ...
    ///
    pub fn parse(stream: &mut dyn Read, capabilities: &Capabilities) -> Result<PathAttribute, Error> {
...
impl ASPath {
    fn parse(stream: &mut dyn Read, length: u16, capabilities: &Capabilities) -> Result<ASPath, Error> {
